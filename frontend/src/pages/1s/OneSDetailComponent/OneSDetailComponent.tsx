...
import s from './OneSDetailComponent.module.scss';

interface IOneSDetailComponentProps {
    theme: 'dark' | 'light',
    logo: string,
    logo_alt: string,
    title: string,
...
export const OneSDetailComponent: React.FC<IOneSDetailComponentProps> = ({ theme, logo, logo_alt, title, content, file_name, alt }) => {
